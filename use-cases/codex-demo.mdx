...
- **Extend Functionality**: Enhance Codex capabilities with additional custom tools and integrations
...
- `model_endpoint`: For locally deployed models, the endpoint URL where chat/completions is available
