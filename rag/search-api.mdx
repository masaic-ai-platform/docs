...
You can find advanced filters in the [OpenAI API Spec](https://platform.openai.com/docs/api-reference/vector-stores/search#vector-stores-search-filters) section.
