...
url = f"http://localhost:8080/v1/vector_stores/{vector_store_id}"
headers = {
    "Authorization": f"Bearer {your_api_key}"
}
...
url = f"http://localhost:8080/v1/vector_stores/{vector_store_id}/files"
headers = {
    "Content-Type": "application/json",
    "Authorization": f"Bearer {your_api_key}"
}
...
url = f"http://localhost:8080/v1/vector_stores/{vector_store_id}/files/{file_id}"
headers = {
    "Authorization": f"Bearer {your_api_key}"
}
