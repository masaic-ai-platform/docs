...
![Load Generation Metrics](/open-responses/assets/load_generation.png)

Here are the trace outcomes from the load generation examples:

![Agent Hands Off Load Generation](/open-responses/assets/agent_hands_off_for_load_generation.png)

![Brave Search Agent Load Generation](/open-responses/assets/brave_search_agent_for_load_generation.png) 