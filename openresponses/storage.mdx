...
Unlike cloud-based AI services, OpenResponses storage offers:

1. **Complete Data Control**: Store all conversation data on your own infrastructure
2. **Flexible Storage Options**: Choose between in-memory storage or MongoDB for persistence
3. **Customizable Retention**: Define your own data retention policies
4. **Integration Flexibility**: Easily integrate with your existing systems and data pipelines
5. **Cost Management**: Optimize storage based on your specific usage patterns
...
For production environments, configure MongoDB storage:
...
Using the OpenAI Python SDK with persistent storage:
...
# Start a conversation with storage enabled
...
For more detailed examples and advanced configurations, see the [API Reference](/api-reference/endpoint/storage). 